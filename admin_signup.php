              ...
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                "post">
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      <input type="password" id="form3Example4cd" class="form-control" name="cpass" />
...
$insert_query="INSERT INTO `admin`(`name`, `email`, `pass`, `cpass`) VALUES ('$uname','$email','$pass','$cpass')";
